/* (C) 2024 */
package com.bot.mis.util.sql.svcimpl;

import com.bot.mis.util.sql.config.AliasToEntityLinkHashMapResultTransformer;
...
public class ExecuteSqlServiceImpl implements ExecuteSqlService {
    @Value("${localFile.mis.xml.todb.directory}")
